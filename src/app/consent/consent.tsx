...
export default function Consent() {
    return (
        <CommonLayout
            ...
            footer={<Form/>}
        >
            <main className="max-h-[50vh] overflow-scroll border-black border rounded-lg shadow-xl">
                <div className="overflow-scroll p-5 rounded whitespace-pre-wrap px-10 mx-10">
