...
export const {setTaskStepByIndex, setAllTasksState, setTaskResultByIndex, setCurrentTaskIndex, setTaskStartTimeByIndex, setTaskEndTimeByIndex} = tasksSlice.actions
